...
Route::group(['prefix' => 'admin','middleware' => ['auth'] ],function() {
    ...
    Route::post('regions/cities', 'RegionController@search')->name('regions.search');
    Route::post('cities/areas', 'CityController@search')->name('cities.search');
    Route::get('newProducts', 'ProductController@newindex')->name('products.new');
    Route::get('soldout', 'ProductController@soldout')->name('products.soldout');
    ...
    Route::get('appointments', 'StylistController@appointments')->name('stylists.appointments');
});
...
Route::group([ 'namespace' => 'Web','as' => 'web.'],function() {
    ...
    Route::get('orders','MyOrderController@index')->name('orders');
    Route::get('orders/{order_id}','MyOrderController@show')->name('orders.show');
    ...
    Route::get('status/notification','HomeController@changeNotify')->name('notification.status');
    ...
    Route::get('shipping_address','ShippingController@index')->name('shipping.index');
    ...
    Route::get('select/address','HomeController@selectAddress')->name('select.address');
    Route::get('esewa/complete','EsewaController@completed')->name('esewa.success');
    Route::get('esewa/failed','EsewaController@failed')->name('esewa.failed');
    Route::post('sentmail/{reciever_id}','MailController@sentMail')->name('sent.mail');
    Route::get('stylists', 'StylistController@index')->name('stylists.index');
    Route::post('stylists/booking', 'StylistController@booking')->name('stylists.booking');
    
    Route::get('mybookings', 'StylistController@myBookings')->name('stylists.myBookings');
    Route::get('bookings/status/{id}/{status}', 'StylistController@changeStatus')->name('bookings.status');
});
