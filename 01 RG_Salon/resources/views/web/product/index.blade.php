            ...
            <div class="row">
                ...
                <div class="col-xl-3 col-lg-4 col-12 order-2 order-lg-1 pr-30 pr-sm-15 pr-md-15 pr-xs-15">
                    ...
                    <div class="sidebar" style="margin-top: 60px;">
                        <h4 class="sidebar-title">Other SubCategories</h4>
                        <ul class="sidebar-list">
                            @foreach($all_subcategories as $all_subcategory)
                                @if($all_subcategory->slug!=\GuzzleHttp\json_decode($slug))
                            <li><a href="{!! route('web.products.index',['cat_slug'=>$all_subcategory->slug]) !!}">{{$all_subcategory->name}}</a></li>
                                @endif
                             @endforeach
                        </ul>
                    </div>
